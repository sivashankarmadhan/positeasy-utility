...
export default function AdditionalPackingChargesDialog({
  open,
  handleClose,
  initialFetch,
 ...
 console.log(' amount',amount);
  ...
  useEffect(() => {
    if (terminalConfiguration) {
      setAmount(get(terminalConfiguration, 'additionalPackingCharges.flatAmount'));
    }
  }, [terminalConfiguration]);
    ...
    <Dialog open={open} onClose={() => setOpen(false)} fullWidth maxWidth="sm">
      ...
      >
        <Box display="flex" alignItems="center" justifyContent="center" gap={1}>
          ...
          >
            Additional Packing Charges Predefined Value
          </Typography>
