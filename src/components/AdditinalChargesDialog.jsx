...
import { amountCommentsState, currentStoreId, currentTerminalId } from 'src/global/recoilState';
...
export default function AdditionalChargesDialog({
  open,
  handleClose,
  initialFetch,
  ...
  useEffect(() => {
    if (terminalConfiguration) {
      setAmount(get(terminalConfiguration, 'additionalCharges.flatAmount'));
    }
  }, [terminalConfiguration]);
    ...
    <Dialog open={open} onClose={() => setOpen(false)} fullWidth maxWidth="sm">
      ...
      >
        <Box display="flex" alignItems="center" justifyContent="center" gap={1}>
          ...
          >
            Additional Charges Predefined Value
          </Typography>
