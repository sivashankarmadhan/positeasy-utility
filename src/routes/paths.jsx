...
export const PATH_DASHBOARD = {
  ...
  inventory: {
    ...
    onlineProductAdd: '/inventory/products/add-online',
    onlineProductEdit: '/inventory/products/edit-online',
    rawMaterials: '/inventory/rawMaterials',
    onlineCategory: '/inventory/onlineCategory',
    optionsGroup: '/inventory/optionsGroup',
    options: '/inventory/options',
    taxesAndCharges: '/inventory/taxesAndCharges',
  ...
  foodDelivery: {
    scanQR: '/foodDelivery/scanQR',
    onlineStores: '/foodDelivery/onlineStores',
    requestLogs: '/foodDelivery/requestLogs',
    FDOrders: '/foodDelivery/orders',
  },
